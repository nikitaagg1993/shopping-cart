...
import { CartCourse, CartCourses, Course } from "../types";

type UserCartComponentProps = {
  cartCourses: CartCourses;
  deleteCourseFromCartFunction: (product: Course) => void;
  totalAmountCalculationFunction: () => number;
  setCartCourses: (courses: any) => void;
};
  ...
  return (
    <div className={`cart ${cartCourses.length > 0 ? "active" : ""}`}>
      ...
      {cartCourses.length === 0 ? (
        ...
        <div>
          <ul>
            {cartCourses.map((item: CartCourse) => (
                    ...
                    <div className="item-actions">
                      ...
                      <div className="quantity">
                        <button
                          style={{ margin: "1%" }}
                          onClick={(e) => {
                            setCartCourses((prevCartCourses: CartCourses) => {
